...
class SecureCheckService
{
    ...
    public function isValid($securityChecks): bool
    {
        ...
        $formTimeout = ((array_key_exists('formTimeout', $this->supportedOptions)) ? intval($this->supportedOptions['formTimeout']) : 5);
